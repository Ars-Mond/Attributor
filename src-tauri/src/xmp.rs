use crate::types::{ReadResult, SaveRequest};
...
// PNG   — chunks up to IEND; XMP may appear in an iTXt chunk before or after IDAT.
...
pub fn read_metadata_impl(path: String) -> Result<ReadResult, String> {
...
pub fn save_metadata_impl(metadata: SaveRequest) -> Result<String, String> {
